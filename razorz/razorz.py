...
USER_AGENT_PARTS = {
    'os': {
        ...
        'windows': {
            'name': [ 'Windows NT 6.1', 'Windows NT 6.3', 'Windows NT 5.1', 'Windows NT.6.2' , 'Windows NT 10.0' ],
            'ext': [ 'WOW64', 'Win64; x64' ]
        },
        'mac': {
            'name': [ 'Macintosh' ],
    ...
    def stats(self):
        ...
        try:
            if self.counter[0] > 0 or self.counter[1] > 0:
                ...
                print "{0} Cleanerz strikes hit. ({1} Failed)".format(self.counter[0], self.counter[1])
...
def main():
    ...
    try:
        ...
        razorz = Cleanerz(url)
        razorz.useragents = useragents
        razorz.nr_workers = workers
        razorz.method = method
        razorz.nr_sockets = socks
